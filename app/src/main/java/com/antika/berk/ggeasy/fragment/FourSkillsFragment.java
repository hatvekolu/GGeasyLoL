...
public class FourSkillsFragment extends DialogFragment {
        ...
        key1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ekran.getText().toString().toLowerCase().equals(son.toString().toLowerCase())){
                    ...
                    if(Integer.parseInt(dbHelper.getMatch("Gorev30"))<=veri)
                        dbHelper.insertMatch(""+(veri+1), "Gorev30");
                    fsf.yenile();
                    getDialog().dismiss();
                }
    ...
    public void yenile(){
        ...
        Picasso.with(getContext()).load("http://ddragon.leagueoflegends.com/cdn/" + fo.getVersion() + "/img/spell/" + fo.getSkillQ()).into(skill1);
        Picasso.with(getContext()).load("http://ddragon.leagueoflegends.com/cdn/" + fo.getVersion() + "/img/spell/" + fo.getSkillE()).into(skill2);
        Picasso.with(getContext()).load("http://ddragon.leagueoflegends.com/cdn/" + fo.getVersion() + "/img/spell/" + fo.getSkillW()).into(skill3);
        Picasso.with(getContext()).load("http://ddragon.leagueoflegends.com/cdn/" + fo.getVersion() + "/img/spell/" + fo.getSkillR()).into(skill4);
